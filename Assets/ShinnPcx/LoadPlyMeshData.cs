...
public class LoadPlyMeshData
{

    public static GameObject ImportToScene(string filepath)
    {
        // Mesh container
        // Create a prefab with MeshFilter/MeshRenderer.
        var gameObject = new GameObject();
        var mesh = ImportAsMesh(filepath);
        ...
        meshRenderer.gameObject.name = Path.GetFileName(filepath);
    ...
    static Mesh ImportAsMesh(string path)
    {
        try
        {
